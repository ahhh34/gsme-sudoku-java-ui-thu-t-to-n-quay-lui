...
public class view extends javax.swing.JPanel {
    ...
    public view() {
        ...
        easyBtn.setBackground(Color.decode("#33E55C"));
        pnlDifferent.add(midBtn);
        midBtn.setBackground(Color.decode("#C7E533"));
        pnlDifferent.add(hardBtn);
        hardBtn.setBackground(Color.decode("#E58033"));
        pnlDifferent.add(superhardBtn);
        superhardBtn.setBackground(Color.decode("#E53333"));
        ...
        pnlOptions.add(nBtn);
        nBtn.setBackground(Color.decode("#AC7561"));
        pnlOptions.add(cBtn);
        cBtn.setBackground(Color.decode("#96FAC8"));
        pnlOptions.add(slove);
        slove.setBackground(Color.decode("#AC7561"));
        pnlOptions.add(save);
        save.setBackground(Color.decode("#96FAC8"));
        pnlOptions.add(reloadsave);
        reloadsave.setBackground(Color.decode("#AC7561"));
        pnlOptions.add(load);
        load.setBackground(Color.decode("#96FAC8"));
        pnlOptions.add(delete);
        delete.setBackground(Color.decode("#AC7561"));
        pnlOptions.add(reset);
        reset.setBackground(Color.decode("#96FAC8"));
        pnlOptions.add(eBtn);
        eBtn.setBackground(Color.decode("#CC0000"));
        ...
        pnlInfor.add(about);
        about.setBackground(Color.decode("#A8CDF3"));
        pnlInfor.add(info);
        info.setBackground(Color.decode("#A8CDF3"));
        pnlInfor.add(tutorial);
        tutorial.setBackground(Color.decode("#A8CDF3"));
